/*
 * star/i6_symbols.h -- dlsym helper shared by the i6_*_load.h loaders
 *
 * divinus's src/hal/symbols.h, reduced to the one helper the i6_* headers
 * ever took from it. It lives here rather than in sigmastar-headers because
 * it reports through raptor's logger: the headers repo describes the MI ABI
 * and nothing more, so anything naming HAL_LOG_* or RSS_ERR_* belongs on
...
#ifndef STAR_I6_SYMBOLS_H
#define STAR_I6_SYMBOLS_H
